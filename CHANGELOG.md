...
- 保留评价最好的小女孩与旁白；成年男性改用专业叙事男声，小男孩改用原生年轻男声。
- Neural 模式取消所有音高变调，老年角色回退为自然成年声，不再模拟夸张老人音。
...
- Neural 映射版本升级至 v2，缓存自动区分旧声线配置。
- `/api/config` 增加免费声线 ID、免费角色数量和声线分层能力合同。
- 增加 Neural 角色试听、免费 / 高级分层、旧项目声线迁移、老人自然回退和原生音高测试；测试增至 67 个。
- 版本升级至 0.9.0。
