...
重启后页面会出现“免费高质量生成”。同一套声线包支持中文与英文：上传内容被判定为纯英文时，自动使用精选的美式 / 英式 English Neural 声线；中文及中英混合内容继续使用中文声线。在线目录当前可见 14 种中文 Neural 声线，本版自动精选其中 9 种普通话 / 国语声线：
...
- 英文声线沿用同一套角色 preset ID，因此角色锁定、别名和跨章节声音一致性逻辑无需改变；
- 纯英文检测要求至少 20 个英文字母且不能出现中日韩统一表意文字，避免把短标题、API 名称或中英混合小说误切到英文声线。
